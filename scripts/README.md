...
| `11_flagellar_trees/` | per-gene + concatenated IQ-TREE flagellar trees on Katana, gCF/sCF, comparison with GTDB | `prepare_gene_sets.py`, `katana/submit.sh`, `compare_to_gtdb.py` |
